...
def main():
    ...
    parser.add_argument("-t", "--train_path", default=None, type=str)
    parser.add_argument("-v", "--val_path", default=None, type=str)
    parser.add_argument("-s", "--test_path", default=None, type=str)
    parser.add_argument("-p", "--presets", default="medium_quality", type=str)
